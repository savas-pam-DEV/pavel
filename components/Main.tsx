...
const services: Service[] = [
  {
    ...
    description: "Підбір і установка кондиціонера будь-якого типу для дому та бізнесу.",
    price: "3200 грн",
  ...
  },
  {
    ...
    description: "Підготовка та прокладка трас для швидкого і якісного монтажу кондиціонерів.",
    price: "3000 грн",
  ...
  },
  {
    ...
    description: "Обслуговування кондиціонерів для чистого повітря і тривалої роботи обладнання.",
    price: "1200 грн",
  ...
  },
  {
    ...
    description: "Надійна вентиляція для будь-якого приміщення.",
    price: "",
